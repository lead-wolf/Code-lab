...
****************************************************/
import { getToken, getUsername } from "/assets/services/localStorageService.js";
import { checkAccessToken } from "/assets/services/authenticationService.js";
...
"use strict";
	...
	windowOn.on('load',function() {
		...
		if (!accessToken) {
			...
			headerBtn.style.display = 'visible';
		}else{
			checkAccessToken();
			if (!accessToken){
				headerDropdown.style.display = 'none';
			...
			$('#header_username').append(getUsername());
			headerDropdown.style.display = 'visible';
