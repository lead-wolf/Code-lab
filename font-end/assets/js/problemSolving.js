                                            ...
                                            <div class="course__content">
                                                <div class="course__meta d-flex align-items-center justify-content-between">
                                                    <div class="course__lesson">
                                                        <span><i class="far fa-book-alt"></i>Điểm tối đa: ${assignment.max_score ? assignment.max_score : 1} </span>
                                                    </div>
                                                    <div class="course__rating">
                                                        <span><i class="icon_star"></i>Tỉ lệ thành công: ${assignment.successRate ? assignment.successRate : 0}%</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="course__teacher d-flex align-items-center">
                                                    ...
                                                    <h6><a href="problemSolving/${assignment.id}">${`Name-Teacher`}</a></h6>
                                                </div>
                                            </div>
                                            <div class="course__more d-flex justify-content-between align-items-center">
                                                <div class="course__status">
                                                    <span class="${getLevelClass(assignment.level.id)}">${assignment.level}</span>
                                                </div>
                                                <div class="course__btn">
                                                    <a href="/client/problem/problemSolving/practice.html?id=${assignment.id}" class="link-btn">
                                                        Giải bài tập
